...
public class SumoTraciConnection {
	...
	private StopVehicleQuery stopVehicleQuery;
	/*
	...
	private void postConnect() throws IOException {
		...
		stopVehicleQuery = new StopVehicleQuery(dis, dos);
	...
	private void runSUMOGUI(int remotePort) throws IOException {
		String sumoEXE = System.getProperty(SUMO_EXE_PROPERTY);
		if (sumoEXE == null)
			sumoEXE = "C:/Users/Dawei/Downloads/veins/sumo-svn/bin/sumo-gui.exe";
	...
	public StopVehicleQuery queryStopVehicle() {
		return stopVehicleQuery;
	}
